...
function total_P=costFun(fn,fn1,delta_t,T,Hf,Hz,len1)
   ...
   delta_v = zeros(1,n);    %储存特定时刻的垂荡速度 无初
  ...
  atho(1) = 0;
   ...
   W1=0,W2=0;
   for j= 2:n
       W1=W1+ kn*Vzhen*delta_t* abs(Vzhen(j)-Vzhen(j-1))/2 ;
   end
